class ResourceAllocationMatricesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @resource_allocation_matrix.save
        format.html { redirect_to @resource_allocation_matrix, notice: 'Resource allocation matrix was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @resource_allocation_matrix.update(resource_allocation_matrix_params)
        format.html { redirect_to @resource_allocation_matrix, notice: 'Resource allocation matrix was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to resource_allocation_matrices_url, notice: 'Resource allocation matrix was successfully destroyed.' }
  ...
  private
    ...
    def resource_allocation_matrix_params
      params.require(:resource_allocation_matrix).permit(:p_id, :workpackage_id, :component_id, :resource_id)
    end
end
