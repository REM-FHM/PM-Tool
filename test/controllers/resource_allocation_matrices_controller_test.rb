...
class ResourceAllocationMatricesControllerTest < ActionController::TestCase
  ...
  test "should create resource_allocation_matrix" do
    assert_difference('ResourceAllocationMatrix.count') do
      post :create, resource_allocation_matrix: { component_id: @resource_allocation_matrix.component_id, p_id: @resource_allocation_matrix.p_id, resource_id: @resource_allocation_matrix.resource_id, workpackage_id: @resource_allocation_matrix.workpackage_id }
    end
  ...
  test "should update resource_allocation_matrix" do
    patch :update, id: @resource_allocation_matrix, resource_allocation_matrix: { component_id: @resource_allocation_matrix.component_id, p_id: @resource_allocation_matrix.p_id, resource_id: @resource_allocation_matrix.resource_id, workpackage_id: @resource_allocation_matrix.workpackage_id }
    assert_redirected_to resource_allocation_matrix_path(assigns(:resource_allocation_matrix))
  end
